...
public class HotelManagementController {
    ...
    @PostMapping("/add-user") // 3 - Post Request
    ...
    @GetMapping("/get-hotel-with-most-facilities") //4 - Get Request
    ...
    @PutMapping("/update-facilities") // Put  - Request
    public Hotel updateFacilities(List<Facility> newFacilities,String hotelName){
        ...
        Hotel ans = hotelManagementService.updateFacilities(newFacilities,hotelName);
        return ans;
    }
